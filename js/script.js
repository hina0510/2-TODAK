...
var guideDetailData = {
  ...
  support: {
    ...
    sections: [
      {
        title: "부모급여",
        content: "2026년에도 영아기 가정의 양육 부담을 줄이기 위해 부모급여가 지원됩니다."
      },
      {
        title: "아동수당",
        content: "아동수당은 아이의 건강한 성장과 양육비 부담 완화를 위해 매월 지급되는 지원금입니다."
      },
      {
        title: "신청 방법",
        content: "지원금은 복지로 온라인 신청 또는 거주지 주민센터 방문을 통해 신청할 수 있습니다. 출생신고 후 가능한 빨리 신청하면 지급 누락을 줄일 수 있습니다."
      },
      {
        title: "확인할 것",
        content: "아이의 나이, 가구 상황, 정책 변경에 따라 달라질 수 있습니다. 신청 전 최신 기준과 지급일, 중복 지원 가능 여부를 확인해주세요."
      }
    ]
  },
  sleep: {
